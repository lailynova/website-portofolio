    ...
    return (
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 justify-center items-center">
            {/* WhatsApp */}
            <div className="group relative bg-[#2c2c2c] p-5 rounded-xl flex items-center gap-4 overflow-hidden shadow-md transition duration-300 hover:shadow-green-500/30 border border-transparent hover:border-green-500/50">
              ...
              <div className="text-left flex-1 z-10">
                ...
                <button className="mt-2 text-sm font-semibold text-white bg-green-600 px-4 py-1 rounded hover:bg-green-700 transition">
                  Send A Message
                </button>
              </div>
            </div>
            ...
            {/* Gmail */}
            <div className="group relative bg-[#2c2c2c] p-5 rounded-xl flex items-center gap-4 overflow-hidden shadow-md transition duration-300 hover:shadow-red-500/30 border border-transparent hover:border-red-500/50">
              ...
              <div className="text-left flex-1 z-10">
                ...
                <button className="mt-2 text-sm font-semibold text-white bg-red-600 px-4 py-1 rounded hover:bg-red-700 transition">
                  Send A Message
                </button>
              </div>
            </div>
            ...
            {/* LinkedIn */}
            <div className="group relative bg-[#2c2c2c] p-5 rounded-xl flex items-center gap-4 overflow-hidden shadow-md transition duration-300 hover:shadow-blue-500/30 border border-transparent hover:border-blue-500/50">
              ...
              <div className="text-left flex-1 z-10">
                ...
                <p className="text-gray-400 text-sm">https://www.linkedin.com/in/akynova/</p>
                <button className="mt-2 text-sm font-semibold text-white bg-blue-600 px-4 py-1 rounded hover:bg-blue-700 transition">
                  Send A Message
                </button>
              </div>
            </div>
